...
<div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <form method="post" action="/dashboard/data-album" class="mb-5" enctype="multipart/form-data">
          @csrf
          <input type="hidden" >
          ...
          <div class="card-body">
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                    <input class="form-control @error('namaAlbum') is-invalid @enderror" type="text" id="namaAlbum" name="namaAlbum">
                    @error('namaAlbum')
    ...
    <div class="col-sm-12 col-md-7">
        <textarea  class="summernote-simple" id="deskripsi" name="deskripsi">{{ old('deskripsi') }} </textarea>
    </div>
    </div>
